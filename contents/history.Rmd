...
공익법인 한국 R 사용자회 주관 교보생명 데이터 전문 디플래닉스 후원을 받아 "인공지능과 데이터 사이언스"를 주제로 R 뿐만 아니라 파이썬, 챗GPT, 쿼토를 아우리며 한 걸음 더 들어가는 개발자 모임입니다.

- **2024년: 인공지능과 데이터 사이언스**
- 2023년: 챗tGPT와 데이터 사이언스
